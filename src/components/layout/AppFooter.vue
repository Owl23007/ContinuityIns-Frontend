<template>
  <footer class="footer">
    <div class="footer-content">
      <div class="footer-section">
        ...
        <div class="social-links">
          <a href="https://github.com/Owl23007" target="_blank" rel="noopener noreferrer" title="GitHub"
            class="social-link">
    ...
    <div class="footer-bottom">
      ...
      <p class="icp-info">
        <a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener noreferrer">鄂ICP备2024073383号-1</a>
      </p>
    </div>
  </footer>
</template>
