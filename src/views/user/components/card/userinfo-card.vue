<template>
    <div class="user-card">
        <div class="user-left">
            ...
            <el-dropdown v-if="isOwnProfile" trigger="click" placement="bottom-end" class="settings-dropdown">
...
import { Message, ChatDotRound, Edit, Camera, Setting, Picture, UserFilled } from '@element-plus/icons-vue'
