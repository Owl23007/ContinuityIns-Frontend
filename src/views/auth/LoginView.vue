  ...
  <div class="auth-container">
    <div class="auth-card" :class="{ 'register-mode': !uiState.isLogin }">
      ...
      <form @submit.prevent="handleSubmit">
        <!-- 用户名输入 -->
        <base-input
          v-model="formData.main.identifier"
          :label="uiState.isLogin ? '用户名/邮箱' : '用户名'"
          required
          :has-error="!!errors.username"
          :error-message="errors.username"
          @input="!uiState.isLogin && validateUsername()"
          @blur="!uiState.isLogin && validateUsername()"
        >
          <template #icon>
            <svg
              aria-hidden="true"
        ...
        <!-- 密码输入 -->
        <password-input
          v-model="formData.main.password"
          label="密码"
          required
        ...
        <CaptchaInput
          ...
          v-model="formData.main.captcha"
          :image-url="uiState.captchaUrl"
          :has-error="!!errors.captcha"
        ...
        <div class="input-group" :class="{ error: errors.passwordConfirm }" v-if="!uiState.isLogin">
          ...
          >
            <svg
              v-if="uiState.showPasswordConfirm"
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              data-icon="eye-slash"
          ...
          <div class="remember-me">
            ...
            <span class="tooltip-icon">
              ...
              <span class="tooltip-text"
                >将通过安全令牌保持登录状态，不会存储任何密码信息，请妥善保管密码！</span
              >
            </span>
          </div>
        </div>
          ...
          <div class="modal-container">
            ...
            <div class="modal-content">
              <div class="input-group" :class="{ error: errors.resetEmail }">
                <input
                  type="email"
                  v-model="formData.reset.email"
                  required
                  @input="validateResetEmail"
                  @blur="validateResetEmail"
                  :class="{ filled: formData.reset.email }"
                  placeholder=" "
                />
                <label>注册邮箱地址</label>
                <span class="icon">
                ...
                <transition name="fade">
                  <div v-if="errors.resetEmail" class="error-message">
                    {{ errors.resetEmail }}
                  </div>
                </transition>
              </div>
